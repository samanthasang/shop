...
const Register = () => {
  ...
  return (
    <section>
      <Row className="singUp-page" gutter={[48, 16]}>
        <Col span={8} offset={8}>
          <Spin spinning={loading}>
            <Card className='singUp-page-form-card' >
              <img
                className="singUp-page-form-card-img haeder-logo logo"
                ...
                alt=""
              />
              <Paragraph className='singUp-page-form-card-text1' >
