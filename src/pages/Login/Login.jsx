...
const Login = () => {
    ...
    return (
        <section>
            ...
            />
            <p style={{ textAlign: "center", width: '100%'}} >از اینکه به Freightos.com پیوستید متشکریم</p>
            <p style={{ textAlign: "center", width: '100%'}} >از بازدید شما از Freightos.com سپاسگزاریم</p>
                        <LoginForm/>
                </Card>
            </Col>
            </Row>
